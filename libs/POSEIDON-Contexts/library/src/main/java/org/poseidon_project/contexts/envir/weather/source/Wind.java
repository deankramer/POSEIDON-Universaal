...
public class Wind {
	...
	public static Wind.Direction getDirection(int degrees) {
		...
		switch (zone) {
			case 0: return Wind.Direction.N;
			case 1: return Wind.Direction.NE;
			case 2: return Wind.Direction.E;
			case 3: return Wind.Direction.SE;
			case 4: return Wind.Direction.S;
			case 5: return Wind.Direction.SW;
			case 6: return Wind.Direction.W;
			case 7: return Wind.Direction.NW;
		}
	...
	public static int convertSpeed(int speed, Wind.SpeedUnit currentSpeedUnit, Wind.SpeedUnit desiredSpeedUnit) {
